    ...
    <style type="text/css">
        ...
        <style type="text/css">
          ...
          {  
           ...
           {
                background:none;
                filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='images/settings2.png' ,sizingMethod='crop');
        ...
        <td class="style1">
               ...
               <div id="full" >
                   ...
                   <div class="logo3" 
                     ...
                     <div id="flashdiv" 
                           style=" position:absolute; top: 229px; left: 3px; width: 172px; height: 245px;">
        ...
        <!-- content -->
              <div id="contentplacer" 
	              ...
	              <div class="diag" style=" position:absolute; top: -22px; left: -17px; height: 123px; width: 178px; background:url(images/dia.png)"></div>
	               ...
	               <div style=" position:absolute; top: 13px; left: 198px; width: 452px; height: 40px; text-align: right;">
   
                     <asp:Label ID="Label1" runat="server" Text="اهلا بكم فى ادارة الزهور للتسويق العقارى" 
                         Font-Bold="True" Font-Names="Arial Unicode MS" Font-Size="X-Large" 
                  ...
                  <div class="icon1" 
                      ...
                      style=" position:absolute;top: 132px; left: 68px; width: 134px; background:url(images/settings2.png); height: 137px;">
                 </div>
                 
    
                 <div style=" position:absolute; top: 108px; left: 446px; width: 191px; height: 26px; text-align: center;">
           
           <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" 
               Font-Names="Tahoma" Font-Size="Large" ForeColor="White" OnClientClick="window.open('Showmessage.aspx')" >عرض رسائل العملاء</asp:LinkButton>
          
       </div>
       
       <div style="position:absolute; top: 198px; left: 453px; width: 184px; height: 22px;" >
              ...
              <asp:LinkButton ID="LinkButton4" runat="server"  
                  ...
                  style="font-weight: 700; font-family: Tahoma; color: #FFFFFF; text-align: center; font-size: large" 
                  onclick="LinkButton4_Click">العقــــارات 
              المطلوبة</asp:LinkButton>
          
       </div>
         
         <div style="position:absolute; top: 154px; left: 449px; width: 184px; height: 22px;" >
              ...
              <asp:LinkButton ID="LinkButton5" runat="server" 
                  ...
                  style="font-weight: 700; font-family: Tahoma; color: #FFFFFF; text-align: center; font-size: large" 
                  onclick="LinkButton5_Click">العقــــارات 
              المعروضة</asp:LinkButton>
