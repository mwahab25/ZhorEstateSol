<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Puplish_Akar.aspx.cs" Inherits="Puplish_Akar" %>
       ...
       <table style= "height:482px ; width: 98%;">
        ...
        <!-- content -->
              <div id="contentplacer" 
	              ...
	              <div style=" position:absolute; top: 42px; left: 415px; width: 235px; height: 29px; text-align: center;">
             <asp:LinkButton ID="LinkButton1" runat="server" 
                
                 
                          style="font-weight: 700; font-family: Tahoma; color: #FFFFFF; text-align: center; font-size: large" 
                          onclick="LinkButton1_Click">عرض العقارات المعروضة</asp:LinkButton> 
	     </div>
                
               
                
          <div style=" position:absolute; top: 80px; left: 424px; width: 229px; height: 28px; text-align: center;" >

              <asp:LinkButton ID="LinkButton2" runat="server" Font-Bold="True" OnClientClick="window.open('GuestBook.aspx', 'any' , 'toolbar,width=700,height=550')"  
                  Font-Names="Tahoma" Font-Size="Large" ForeColor="White">اعـــــــــرض 
              عـــــقـــــــار</asp:LinkButton>
          </div>
            
         <div class="icon1" 
             
                      style=" position:absolute; top: 101px; left: 90px; background:url(images/home.png); width: 189px; height: 150px;">
