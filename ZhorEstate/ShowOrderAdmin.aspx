<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowOrderAdmin.aspx.cs" Inherits="ShowOrderAdmin" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>عرض العقارات المطلوبة</title>
              ...
              <div id="contentplacer" 
	              ...
	              <div class="diag" style=" position:absolute; top: -22px; left: -17px; height: 123px; width: 178px; background:url(images/dia.png)"></div>
                      <div style=" position:absolute; top: 23px; left: 204px; height: 40px; width: 254px;">
                          ...
                          <asp:Label ID="Label1" runat="server" Text="العقارات المطلوبة" Font-Bold="True" 
