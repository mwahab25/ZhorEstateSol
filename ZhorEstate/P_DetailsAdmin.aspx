<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P_DetailsAdmin.aspx.cs" Inherits="P_DetailsAdmin" %>
...
<body id="back">
    <form id="form1" runat="server">
        ...
        <table style= "height:1772px ; width: 98%;">
        <tr>
        ...
        <!-- content -->
              <div id="contentplacer" 
                                ...
                                style=" position:absolute; top: 158px; left: 149px; width: 660px; height: 1641px;">
	              <div class="diag" style=" position:absolute; top: -22px; left: -17px; height: 123px; width: 178px; background:url(images/dia.png)"></div>
                 
	             <div style=" position:absolute; background-color:#84bbf3; top: 49px; left: 98px; width: 465px; height: 1569px; ">
                 ...
                 <div style=" position:absolute; background-color:#b6dda9; top: 6px; left: 114px; width: 202px; height: 54px; z-index:1;">
                     ...
                     <div style=" position:absolute; top: 277px; left: 311px;">
                      ...
                      <div style=" position:absolute; top: 285px; left: 14px; width: 289px; text-align: right;">
                          ...
                          <asp:Label ID="type" runat="server" Text="Label" Font-Bold="True" 
                              Font-Names="Arial Unicode MS" Font-Size="Large" style="text-align: right"></asp:Label>
                      </div>
                    ...
                    <hr  style=" position:absolute; background-color:White; top: 863px; left: 1px; width: 457px; height: -8px; width:460px;"/> 
                     
                       <div style=" position:absolute; top: 599px; left: 99px;">
                    ...
                    <hr  style=" position:absolute; background-color:White; top: 1177px; left: 3px; width: 457px; height: -8px; width:460px;"/> 
                     
                     
                     <div style=" position:absolute; top: 901px; left: 100px;">
                     
                         <asp:Image ID="Image2" runat="server" style=" width:250px ; height:250px;"/>
                     </div>
                    ...
                    <hr  style=" position:absolute; background-color:White; top: 60px; left: 2px; width: 457px; height: -8px; width:460px;"/> 
                      ...
                      <div style=" position:absolute; top: 1211px; left: 103px; height: 247px; width: 249px;">
                      
                          <asp:Image ID="Image3" runat="server" style=" width:250px ; height:250px;"/>
                      </div>
                     
                     <hr  style=" position:absolute; background-color:White; top: 1466px; left: 2px; width: 457px; height: -8px; width:460px;"/> 
                     
                     <div style=" position:absolute; top: 1512px; left: 60px; height: 28px; width: 161px;">
                     ...
                     <div style=" position:absolute; top: 1512px; left: 253px; height: 28px; width: 161px;">
              ...
              <div id="footer" 
                                ...
                                style=" position:absolute; background-image:url('images/footer.png'); top: 1800px; left: 83px; width: 916px; height: 172px; padding-bottom:10px;">
             </div>
