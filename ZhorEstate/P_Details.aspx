<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P_Details.aspx.cs" Inherits="P_Details" %>
    ...
    <table style= "height:1772px ; width: 98%;">
        ...
        <!-- content -->
              <div id="contentplacer" 
                            ...
                            style=" position:absolute; top: 158px; left: 149px; width: 660px; height: 1558px;">
	              <div class="diag" style=" position:absolute; top: -22px; left: -17px; height: 123px; width: 178px; background:url(images/dia.png)"></div>
                 
	             <div style=" position:absolute; background-color:#84bbf3; top: 49px; left: 98px; width: 465px; height: 1482px; ">
              ...
              <div id="footer" 
                            ...
                            style=" position:absolute; background-image:url('images/footer.png'); top: 1717px; left: 88px; width: 916px; height: 172px; padding-bottom:10px;">
             </div>
