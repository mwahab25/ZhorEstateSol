...
public partial class ShowAkarsAdmin : System.Web.UI.Page
{
    ...
    {
        //string A_ID = GridView1.DataKeyNames.ToString();

        //Response.Redirect("Webform2.aspx?id=" + A_ID);
    }
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "details")
            {
                ...
                Response.Redirect("P_DetailsAdmin.aspx?id=" + A_ID);
            }
        }
        catch
        {
